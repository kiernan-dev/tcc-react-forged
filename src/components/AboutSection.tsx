...
const AboutSection: React.FC = () => {
  ...
  return (
    <section id="about" className="py-20 bg-gradient-to-b from-black via-gray-900 to-black relative overflow-hidden z-30">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          {stats.map((stat, index) => (
            <motion.div
              key={index}
              className="text-center bg-gradient-to-r from-orange-500/40 to-amber-900/20 border border-amber-500/30 rounded-lg p-6"
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <motion.div
                key={index}
                className="text-center group bg-black/40 border border-amber-500/30 rounded-lg p-6"
                initial={{ opacity: 0, y: 20 }}
                animate={inView ? { opacity: 1, y: 0 } : {}}
        ...
        <motion.div
          ...
          className="text-center bg-gradient-to-r from-amber-500/10 to-orange-600/50 border border-amber-500/40 rounded-lg p-8"
        >
