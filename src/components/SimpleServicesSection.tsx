...
const SimpleServicesSection: React.FC = () => {
	...
	return (
		<section id="services" className="relative py-20 bg-radial-gradient from-yellow-500 via-orange-900 to-black-500 z-30">
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">		
				...
				<motion.div
					...
					className="text-center mb-16 bg-black/60 rounded-xxl p-8 shadow-lg"
				>
				...
				<div className="grid lg:grid-cols-2 gap-8 mb-16">
					{services.map((service, index) => (
						<motion.div
							...
							className="group relative overflow-hidden bg-gray-800 hover:bg-gray-750 transition-all duration-300 min-h-[400px] rounded-xxl shadow-lg"
						>
							{/* Background Image */}
							<div 
							...
							<div className="relative z-10 p-8 h-full flex flex-col justify-between">
								...
								{/* Simple Border */}
								<div className="absolute inset-0 border-2 border-transparent rounded-xxl group-hover:border-amber-500/70 transition-all duration-300"></div>
							</div>
						</motion.div>
					))}
				</div>
