...
const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-b from-black via-orange-700 to-black relative overflow-hidden z-20">
      ...
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-red via-red/80 to-orange/40"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="flex flex-col sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-8 text-gray-400 mb-6">
            <span>Custom V-Twin Specialists</span>
            <span className="hidden sm:inline">|</span>
            <span>Basehor, KS</span>
          </p>
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-8 text-gray-400">
